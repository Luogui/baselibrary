 ...
 * 4.销毁p和q。
 * <p>
 * 最终得到的N和e就是“公钥”，d就是“私钥”，
 * 发送方使用N去加密数据，接收方只有使用d才能解开数据内容。
 * RSA的安全性依赖于大数分解，小于1024位的N已经被证明是不安全的，
 * 而且由于RSA算法进行的都是大数计算，使得RSA最快的情况也比DES慢上倍，这是RSA最大的缺陷，
 * 因此通常只能用于加密少量数据或者加密密钥，但RSA仍然不失为一种高强度的算法。
 * <p>
...
public class RSA {
     ...
     * 随机生成RSA密钥对
     *
     * @param keyLength 密钥长度，范围：512～1204  一般1024
     * @return
     */
    ...
    public static byte[] encryptByPublicKey(byte[] data, byte[] publicKey) throws Exception {
        ...
        // 加密数据
        Cipher cp = Cipher.getInstance(RSA_ECB_PADDING);
