...
public class SplashDialog extends Dialog {
            ...
            switch(message.what) {
                case 0:
                    ...
                    if (length > 0) {
                        ...
                        progressView.setProgress(mPercent);
    ...
    public SplashDialog(Context context) {
        ...
        super(context,context.getResources().getIdentifier("Splash", "style", context.getPackageName()));
        mContext = context;
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(mContext.getResources().getIdentifier("splash_dialog", "layout", mContext.getPackageName()));
        mTipsView = (TextView)findViewById(mContext.getResources().getIdentifier("tipsView", "id", mContext.getPackageName()));
        mLayout = findViewById(mContext.getResources().getIdentifier("layout", "id", mContext.getPackageName()));
        progressView = findViewById(mContext.getResources().getIdentifier("loading_progressBar", "id", mContext.getPackageName()));
